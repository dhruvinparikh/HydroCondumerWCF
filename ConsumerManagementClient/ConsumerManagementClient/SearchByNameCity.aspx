<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchByNameCity.aspx.cs" Inherits="ConsumerManagementClient.SearchByNameCity" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Search By name/city</title>
</head>
<body>
            ...
            <asp:TableHeaderRow>
                ...
                <asp:TableHeaderCell>
                    <asp:DropDownList ID="searchByList" runat="server">
                     <asp:ListItem Text="First Name" Value="0" Selected="True" />
                        <asp:ListItem Text="Last Name" Value="1" />
